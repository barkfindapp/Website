    ...
    <section ref={sectionRef} className="py-20 bg-white overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12 md:gap-16">
        <div className="flex-1 text-center md:text-left order-2 md:order-1">
          <p className="text-sm font-bold text-rust uppercase tracking-widest mb-3">See it in action</p>
          <h2 className="font-serif text-3xl md:text-4xl text-ink mb-4 leading-tight">
            The whole walk, sorted in a few taps
          </h2>
          <p className="text-lg text-ink/70 leading-relaxed max-w-md mx-auto md:mx-0">

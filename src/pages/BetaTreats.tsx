...
import TierTrack from "../components/beta/TierTrack";
...
const REDEEM_STEPS = [
  ...
  { n: 3, title: "Tap Redeem", body: "That's the whole step. There's no code to type in and no voucher to keep hold of." },
  { n: 4, title: "Apple applies it for you", body: "Your reward is applied to your subscription through Apple's own offer system. A discount lands on your next billing cycle; a free year is added to your term." },
];
...
const FAQ = [
  ...
  { q: "Do my reviews need photos?", a: "No. Photos are welcome and they really help other dog owners, but they don't affect your points at all. What earns the second point is a written description of 40 characters or more." },
  { q: "What counts towards a point?", a: "An approved review of a dog-friendly place you've genuinely visited. Reviews are moderated, so only approved ones earn points, and an approved review with 40 or more characters of description is worth two." },
  ...
  { q: "I'm on annual, how does a discount work for me?", a: "Annual accounts get one Treat claim, for life, delivered as extra time added to your subscription rather than a percentage off a single yearly bill. The 50-point free year works the same way, a year added to your term." },
  { q: "My reward hasn't appeared, what do I do?", a: "Email info@barkfind.com with your account email and the reward you claimed, and we'll sort it out. Remember there's no code to enter. Apple applies the reward to your subscription directly." },
];
...
export default function BetaTreats() {
  return (
    <PageShell
    ...
    >
      ...
      <Section title="How you earn points">
        ...
        <p className="text-sm text-[#585858]">A sentence or two about your visit earns double. Only approved reviews count. Reviews are moderated.</p>
      </Section>

      {/* Tiers, interactive */}
      <Section title="The rewards">
        <p>Your points unlock treats at three tiers. Have a play:</p>
        <div className="mt-2">
          <TierTrack />
        </div>
      </Section>
      ...
      <Section title="Monthly vs annual">
        <div className="rounded-2xl bg-[#FAEFD1] border border-[#B74217]/15 p-6 flex flex-col gap-3 text-sm text-[#444]">
          ...
          <p>
            <strong className="text-[#1a1a1a]">On an annual plan:</strong> you get one Treat claim per account, for
            life. A single annual bill doesn't take the rolling 25%/50% discounts. Instead, your reward is delivered as
            extra time added to your subscription.
          </p>
          <p>
            <strong className="text-[#1a1a1a]">The 50-point free year</strong> applies to both plans, a full year added
            to your subscription, on us.
          </p>
        </div>
      </Section>
      ...
      <Section title="How to redeem your Treat">
        ...
        <div className="rounded-xl bg-[#FAEFD1] border border-[#B74217]/15 p-4 mt-2 text-sm text-[#585858]">
          Rewards are applied to your subscription by Apple, through their own offer system. There's no code to enter
          and no voucher to keep. If a claim doesn't appear, email{" "}
          <a href="mailto:info@barkfind.com" className="text-[#B74217] font-semibold hover:underline">info@barkfind.com</a>{" "}
          with your account email and the reward you claimed.
        </div>
      </Section>
